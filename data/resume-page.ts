...
const certifications = {
  ...
  description:
    "A collection of certifications that reflect my continuous learning and practical experience in web development technologies.",
  items: [
    {
    ...
    {
      title: "Fundamental Back-End dengan JavaScript",
      organization: "Dicoding Academy",
      year: "Feb 2025",
